...
public abstract class Category_ {
	...
	/**
	 * @see qh.synji.entity.Category#images
	 **/
	public static volatile SingularAttribute<Category, String> images;
	
	/**
	 * @see qh.synji.entity.Category#categoryname
	 **/
	public static volatile SingularAttribute<Category, String> categoryname;
	
	/**
	 * @see qh.synji.entity.Category#videos
	 **/
	public static volatile ListAttribute<Category, Video> videos;
	
	/**
	 * @see qh.synji.entity.Category
	 **/
	public static volatile EntityType<Category> class_;
	
	/**
	 * @see qh.synji.entity.Category#categoryid
	 **/
	public static volatile SingularAttribute<Category, Integer> categoryid;
	
	/**
	 * @see qh.synji.entity.Category#status
	 **/
